...
{
    // m_steering_angle_enable com.eprosima.idl.parser.typecode.PrimitiveTypeCode@3891771e
    m_steering_angle_enable = false;
    // m_steering_angle com.eprosima.idl.parser.typecode.PrimitiveTypeCode@78ac1102
    m_steering_angle = 0.0;
    // m_target_acceleration_enable com.eprosima.idl.parser.typecode.PrimitiveTypeCode@7e0e6aa2
    m_target_acceleration_enable = false;
    // m_target_acceleration com.eprosima.idl.parser.typecode.PrimitiveTypeCode@365185bd
    m_target_acceleration = 0.0;
    // m_indicator_left_enable com.eprosima.idl.parser.typecode.PrimitiveTypeCode@18bf3d14
    m_indicator_left_enable = false;
    // m_indicator_left com.eprosima.idl.parser.typecode.PrimitiveTypeCode@4fb64261
    m_indicator_left = false;
    // m_indicator_right_enable com.eprosima.idl.parser.typecode.PrimitiveTypeCode@42607a4f
    m_indicator_right_enable = false;
    // m_indicator_right com.eprosima.idl.parser.typecode.PrimitiveTypeCode@782663d3
    m_indicator_right = false;
    // m_gear_position_enable com.eprosima.idl.parser.typecode.PrimitiveTypeCode@1990a65e
    m_gear_position_enable = false;
    // m_gear_position com.eprosima.idl.parser.typecode.PrimitiveTypeCode@64485a47
    m_gear_position = 0;
    // m_ebrake_status_enable com.eprosima.idl.parser.typecode.PrimitiveTypeCode@25bbf683
    m_ebrake_status_enable = false;
    // m_ebrake_status com.eprosima.idl.parser.typecode.PrimitiveTypeCode@6ec8211c
    m_ebrake_status = 0;
    // m_lane_change com.eprosima.idl.parser.typecode.PrimitiveTypeCode@7276c8cd
    m_lane_change = 0;
    // m_timestamp com.eprosima.idl.parser.typecode.PrimitiveTypeCode@544a2ea6
    m_timestamp = 0;
...
/*!
 * @brief This function sets a value in member lane_change
 * @param _lane_change New value for member lane_change
 */
void remote_msgs::ControlCmd::lane_change(
        int32_t _lane_change)
{
    m_lane_change = _lane_change;
}

/*!
 * @brief This function returns the value of member lane_change
 * @return Value of member lane_change
 */
int32_t remote_msgs::ControlCmd::lane_change() const
{
    return m_lane_change;
}

/*!
 * @brief This function returns a reference to member lane_change
 * @return Reference to member lane_change
 */
int32_t& remote_msgs::ControlCmd::lane_change()
{
    return m_lane_change;
}
