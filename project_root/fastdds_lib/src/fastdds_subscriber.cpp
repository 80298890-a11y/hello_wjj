...
void FastDDSSubscriber::setDriveStateCallback(DriveStateCallback callback) {
    drive_state_callback_ = callback;
}

void FastDDSSubscriber::setFaultReportCallback(FaultReportCallback callback) {
    fault_report_callback_ = callback;
}
