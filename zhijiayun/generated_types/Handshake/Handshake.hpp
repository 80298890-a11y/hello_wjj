...
public:
    ...
    {
        return (m_noa_active_request == x.m_noa_active_request &&
           m_remote_override_status == x.m_remote_override_status &&
           m_remote_override_ready == x.m_remote_override_ready &&
           m_timestamp == x.m_timestamp);
    }
...
private:
    ...
    int32_t m_noa_active_request{0};
    int32_t m_remote_override_status{0};
    int32_t m_remote_override_ready{0};
...
public:
    ...
    {
        return (m_noa_active_response == x.m_noa_active_response &&
           m_remote_override_response == x.m_remote_override_response &&
           m_current_control_source == x.m_current_control_source &&
           m_timestamp == x.m_timestamp);
    }
...
private:
    ...
    int32_t m_noa_active_response{0};
    int32_t m_remote_override_response{0};
